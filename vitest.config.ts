...
export const alias = [
  ...
  { find: /^pi-terminal-headless\/(.+)$/, replacement: `${resolve(root, 'packages/pi-terminal-headless/src')}/$1` },
  { find: 'pi-terminal-headless', replacement: resolve(root, 'packages/pi-terminal-headless/src/index.ts') },
