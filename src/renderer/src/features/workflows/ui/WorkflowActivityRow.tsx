    ...
    >
      ...
      <div className="min-w-0">
        <button
          ...
          className="flex w-full min-w-0 cursor-pointer items-baseline gap-2 text-left text-[12px] leading-[1.5] hover:bg-surface-hi outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-focus-ring"
        >
