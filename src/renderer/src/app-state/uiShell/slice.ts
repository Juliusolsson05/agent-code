...
> = (set, get) => ({
  ...
  openReportHistory: (sessionId, kind) =>
    set({ reportHistory: { sessionId, kind } }, false, 'uiShell/openReportHistory'),
  closeReportHistory: () =>
    set({ reportHistory: null }, false, 'uiShell/closeReportHistory'),
