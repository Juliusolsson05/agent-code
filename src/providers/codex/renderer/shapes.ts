...
export const CODEX_RENDER_SHAPES = defineRenderShapeCatalog('codex', {
  ...
  'codex.semantic.message.v1': defineRenderShape({
    ...
    disposition: { kind: 'planned', targetGrammar: 'structured-tool' },
    why: 'Seeded from the 48-bundle corpus (189 sightings); structural variants share this id.',
  }),
  ...
  'codex.tool-result.tool-result.v1': defineRenderShape({
    ...
    provider: 'codex',
    fingerprints: ["fp1-15e047a5","fp1-21efabc3","fp1-4e69977f","fp1-552115d3","fp1-583da865","fp1-5b0abcb6","fp1-6076e8b0","fp1-69273a71","fp1-762b172b","fp1-76329f0c","fp1-7c1eb034","fp1-7da3932e","fp1-7e89b9ea","fp1-8571cc95","fp1-88b1bc64","fp1-a48dc883","fp1-ab1aaae5","fp1-bff81d04"],
    ...
    why: 'Seeded from the 48-bundle corpus (244 sightings); structural variants share this id.',
  }),
