export type KeybindingEvent = { key: string; code: string; metaKey: boolean; ctrlKey: boolean; altKey: boolean; shiftKey: boolean }
 ...
 */
export function keybindingFromEvent(event: KeybindingEvent): Keybinding | null {
  const modifiers: Modifier[] = []
...
function keyTokenFromEvent(event: KeybindingEvent): string | null {
...
export function eventMatchesKeybinding(event: KeybindingEvent, binding: Keybinding): boolean {
