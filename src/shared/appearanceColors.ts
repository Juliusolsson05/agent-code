// Shared token vocabulary for appearance settings and extension manifest validation.
// Keeping one list means a host token cannot silently be unavailable to authors.
