...
- delete the two old dispatch ladders, JSX provider dispatch capabilities, duplicate result rows, and obsolete artifact resolvers;
...
- `src/renderer/src/features/feed/ui/operations/FileOperation.tsx`
- `src/renderer/src/features/feed/ui/operations/CommandOperation.tsx`
- `src/renderer/src/features/feed/ui/operations/LookupOperation.tsx`
- `src/renderer/src/features/feed/ui/operations/CollaborationOperation.tsx`
- `src/renderer/src/features/feed/ui/operations/StructuredOperation.tsx`
- `src/renderer/src/features/feed/ui/operations/GenericOperation.tsx`
...
- `src/renderer/src/features/feed/ui/resolve/fromCommitted.ts`
