...
Agent Code created the leaf skill directory, bound to that directory's physical
identity so ownership cannot transfer to a replacement. Before changing a provider file,
