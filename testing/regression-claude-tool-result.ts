...
import type { SemanticRuntimeState } from '../src/renderer/src/tiles/workspaceState.ts'
...
async function main(): Promise<void> {
  ...
  const { foldSemanticEvent } = await import('../src/renderer/src/tiles/workspaceStore.ts')
